...
const Signup = () => {
  ...
  // Handle social login (Google in this case)
  const handleSocialLogin = async (provider) => {
    ...
    try {
      ...
      // You can use the user data (like user.displayName, user.email) here
      console.log(user);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const user = result.user;
      // Set the user's display name after email/password signup
        ...
        <div className="relative z-1 mx-auto max-w-c-1016 px-7.5 pb-7.5 pt-10 lg:px-15 lg:pt-15 xl:px-20 xl:pt-20">
          ...
          >
            <div className=" w-full  p-2 flex justify-center ">
              <Image src="/datahubLogo-cropped.jpg" alt="DataHub Logo" width="1001" height="1100" />
            </div>
            ...
            <div className="flex items-center gap-8">
              ...
              >
                ...
                <span className="hidden sm:block">Signup with Google</span>
              </button>
              ...
              >
                ...
                <span className="hidden sm:block">Signup with Github</span>
              </button>
            </div>
